# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            'peepl_audit_session/static/src/js/session_tracker.js',
            'peepl_audit_session/static/src/js/session_debug.js',
            'peepl_audit_session/static/src/js/session_end_beacon.js',
        ],
    },
    'installable': True,
    'application': True,
